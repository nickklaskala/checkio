...
def verify_anagrams(first_word, second_word):
	fwd,swd={},{}
	for l in set(first_word.lower().replace(' ','')):
		fwd[l]=first_word.lower().count(l)
	for l in set(second_word.lower().replace(' ','')):
		swd[l]=second_word.lower().count(l)
	return True if fwd==swd else False



first_word, second_word="Programming", "Gram Ring Mop"
...
print(fwd)
print(swd)
print(True if fwd==swd else False)

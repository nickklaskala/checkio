...
# If a few numbers have an equal frequency - they should be sorted according to their natural order. For example: [5, 2, 4, 1, 1, 1, 3] ==> [1, 1, 1, 2, 3, 4, 5]
# 
# 
# 
...
def frequency_sorting(numbers):
	x=sorted(numbers, key=lambda x: (-numbers.count(x),x))
	return x
